...
Public Class FullNode_Wallet
    ...
    Private Sub lbl_currentblock_TextChanged(sender As Object, e As EventArgs) Handles lbl_currentblock.TextChanged
        ...
        End If
    End Sub
    Private Sub lbl_statusTransaktion_Click(sender As Object, e As EventArgs) Handles lbl_statusTransaktion.Click
        If Not waitforTransaktion Then
            Process.Start(lbl_statusTransaktion.Tag)
        End If
    End Sub
